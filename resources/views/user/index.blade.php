<x-app-layout>
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('memberlist')}}" class="mt-4">
            ...
            <span class="items-center text-sm mt-2 text-gray-800 leading-tight" >※Nameで検索できます　　　</span>
            <div class="md:flex">
            <div class="flex" >
            ...
            <table class="md:w-full bg-white table-auto w-full text-center whitespace-no-wrap">
                <thead>
                    <tr>
                        ...
                        <th class="w-2/10 md:2/10 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Role</th>
