<x-app-layout>
    <x-slot name="header">
        ...
        <div class="md:flex-auto p-1 text-gray-900 dark:text-gray-100  ">
            ...
            <button type="button" class="w-32 h-8 ml-4 border-gray-900 flex-auto p-0 text-sm text-white dark:text-white bg-indigo-400  hover:bg-indigo-600 rounded" onclick="location.href='" >＊＊＊</button>
