            ...
            <table class="md:w-2/3 bg-white table-auto text-center whitespace-no-wrap">
               <thead>
                    <tr>
                        ...
                        <th class="w-4/12 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">YM</th>
                        <th class="w-2/12 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">YMD</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="w-2/12 md:px-4 py-1">{{ $budget->shop_id }}</td>
                        <td class="w-4/12 md:px-4 py-1"> {{ $budget->YM }}</td>
                        <td class="w-2/12 md:px-4 py-1"> {{ $budget->YMD }}</td>
                        <td class="w-4/12 pr-10 md:pr-30 text-right">{{ number_format($budget->bg_kingaku )}}</td>
