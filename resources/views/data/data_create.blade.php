                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="-m-2">
                        ...
                        <form method="POST" action="{{ route('admin.data.sales_upload') }}" class=" p-1" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="w-36 text-sm text-white bg-green-500 border-0 py-1 px-4 focus:outline-none hover:bg-green-600 rounded">売上データ追加</button>
                        </form>
                        ...
                        <form method="POST" action="{{ route('admin.data.stock_upload') }}" class=" p-1" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="w-36 text-sm text-white bg-green-500 border-0 py-1 px-4 focus:outline-none hover:bg-green-600 rounded">在庫データ更新</button>
                        </form>
                        ...
                        <form method="POST" action="{{ route('admin.data.shop_upsert') }}" class=" p-1" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="w-36 text-sm text-white bg-blue-500 border-0 py-1 px-4 focus:outline-none hover:bg-blue-600 rounded">店舗データ更新</button>
                        </form>
                        ...
                        <form method="POST" action="{{ route('admin.data.ym_upsert') }}" class="ml-0 p-1" enctype="multipart/form-data">
                            @csrf
                            <label for="ym_data" class="leading-7 text-sm text-gray-600 mr-2">YMデータ</label>
                        ...
                        <form method="POST" action="{{ route('admin.data.yw_upsert') }}" class="ml-0 p-1" enctype="multipart/form-data">
                            @csrf
                            <label for="yw_data" class="leading-7 text-sm text-gray-600 mr-2">YWデータ</label>
