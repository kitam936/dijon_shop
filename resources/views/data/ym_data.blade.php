    ...
    <div class="py-6 border">
        <div class=" mx-auto sm:px-4 lg:px-4 border ">
            <table class="md:w-2/3 bg-white table-auto text-center whitespace-no-wrap">
               <thead>
                    <tr>
                        <th class="w-2/12 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">YM</th>
                        <th class="w-4/12 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">prev_YM</th>
                ...
                <tbody>
                    @foreach ($yms as $ym)
                    <tr>
                        <td class="w-2/12 md:px-4 py-1">{{ $ym->YM }}</td>
                        <td class="w-4/12 md:px-4 py-1"> {{ $ym->prev_YM }}</td>
