<x-app-layout>
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('admin.hinban_image_check')}}" class="mt-4">
            ...
            <div class="lg:flex">
                ...
                <div class="pl-2 mt-0 md:mt-0 md:ml-0 ml-0 ">
                    ...
                    <button type="button" class="w-16 h-8 bg-blue-500 text-sm text-white ml-0 hover:bg-blue-600 rounded lg:ml-2 " onclick="location.href='{{ route('admin.hinban_image_csv') }}'" >CSVダウンロード</button>
                </div>
            ...
            <table class="md: bg-white table-auto w-full text-center whitespace-no-wrap">
               <thead>
                    <tr>
                        ...
                        {{-- <th class="w-1/8 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">M売価</th> --}}
                ...
                <tbody>
                    ...
                    <tr>
                        {{-- <td class="w-1/15 md:px-4 py-1"> {{ $image->year_code }} </td>
                        <td class="w-1/15 md:px-4 py-1">{{ $image->brand_id }}</td>
                        <td class="w-1/15 md:px-4 py-1">{{ $image->season_name }}</td>
                        <td class="w-1/15 md:px-4 py-1"> {{ $image->unit_id }}</td>
                        <td class="w-1/15 md:px-4 py-1"> {{ $image->face }}</td> --}}
                        ...
                        {{-- <td class="w-1/8 md:px-4 py-1 md:pr-12 text-right">{{ number_format($image->m_price )}}</td> --}}
