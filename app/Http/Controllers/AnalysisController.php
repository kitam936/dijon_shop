...
class AnalysisController extends Controller
{
    public function analysis_index()
    {
        ...
        // dd($logIn_user,$my_shop);
        return view('analysis.analysis_menu',compact('logIn_user','my_shop'));
    }
    ...
    public function sales_total(Request $request)
    {
        ...
        // 比較データを作成
            ...
            return view('analysis.sales_total', compact('YMs','max_YM','YWs','areas','max_YW','brands','datas','seasons','units','faces','total','pv_total','merged_data'));
        }
        ...
        if($request->type1 == 'co'){
            ...
            // dd($datas);
            return view('analysis.sales_total',compact('YMs','max_YM','YWs','max_YW','areas','brands','datas','seasons','units','faces','total','pv_total','merged_data'));
        }
